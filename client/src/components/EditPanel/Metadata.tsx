...
const Metadata = () => {
  return (
   ...
   <div className="bg-surface-container-low border border-outline-variant rounded-xl p-card-padding">
                        ...
                        <ul className="space-y-4 font-body-md text-body-md text-on-surface">
                            <li className="flex justify-between items-center pb-2 border-b border-surface-container-high">
                                ...
                                <span className="font-code text-code text-on-surface">128</span>
                            </li>
                            <li className="flex justify-between items-center pb-2 border-b border-surface-container-high">
