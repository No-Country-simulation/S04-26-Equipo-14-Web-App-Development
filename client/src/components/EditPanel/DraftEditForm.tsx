...
type DraftsEditFormProps = {
    draft: Draft;
}

const DraftEditForm = ({ draft }: DraftsEditFormProps) => {
                ...
                <div
                    ...
                    <div>
                        <div className="flex items-center justify-between mb-2">
                            ...
                            {/* Estos botones deben quedar funcionales!! */}
                        ...
                        <textarea
                            className="w-full bg-surface border border-outline-variant rounded-lg px-4 py-3 text-on-surface font-body-md leading-relaxed focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all resize-y" rows={12} value={draft.content}>


                            {/* {draft.content} */}

                            Estamos ampliando nuestro equipo de ingeniería en el nuevo Tech Hub de Madrid. Buscamos perfiles con experiencia en arquitecturas distribuidas, microservicios y despliegues en cloud (AWS/GCP).
